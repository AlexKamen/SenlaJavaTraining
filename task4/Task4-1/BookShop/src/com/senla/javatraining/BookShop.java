...
public class BookShop implements IBookShop {
	...
	public static final int OLD_BOOKS_MONTHS_NUMBER = 6;
	...
	public ArrayList<Order> getOrders(Date dateStart, Date dateEnd, int orderby,
		...
		for (Order order : allOrders) {
			if ((dateStart != null) && (dateEnd != null)
					&& (order.getDateCreation().getTime() > dateStart.getTime())
	...
	private void checkOrdersCompletion() {
	...
	private void checkApplicationsCompletion() {
